...
export function CodingCliLocalConfigFields({
  isCreate,
  values,
  set,
  config,
  ...
  return (
    <>
      <Field label="Command" hint="Local coding CLI executable (e.g. codex, cursor-agent, custom binary).">
        <DraftInput
          value={
            isCreate
              ? values!.command
