...
- **Update work tracking**: update your assigned issue with a brief status comment (what you’re doing next).
...
- **Notice a gap**: when a task needs a capability you don’t have (new integration, new research method, new workflow).
...
- Recall relevant memory (don’t re-invent decisions).
